...
public class AppUnitOfWork : BaseUnitOfWork<AppDbContext>, IAppUnitOfWork
    {
        ...
        public IBodyMeasurementsRepository BodyMeasurements => GetRepository(() => new BodyMeasurementsRepository(UowDbContext, Mapper));
        ...
        public IPatternInstructionRepository PatternInstruction => GetRepository(() => new PatternInstructionRepository(UowDbContext, Mapper));

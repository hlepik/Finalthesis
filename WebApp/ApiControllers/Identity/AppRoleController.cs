...
[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class AppRoleController : ControllerBase
    {
        ...
        [Produces("application/json")]
        [Consumes("application/json")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(PublicApi.DTO.v1.Identity.AppRole))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(Message))]
        public async Task<IActionResult> DeleteUsersFromRole(PublicApi.DTO.v1.Identity.AppRole appRole)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(PublicApi.DTO.v1.Identity.AppRole))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(Message))]
        public async Task<IActionResult> AddToRole(PublicApi.DTO.v1.Identity.AppRole appRole)
        {
            var appUser = await _userManager.FindByIdAsync(appRole.Id.ToString());
            if (appUser == null)
            {

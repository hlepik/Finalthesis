...
public class BodyMeasurements : DomainEntityId
    {
        ...
        public float WaistLenghtFirst { get; set; }
        public float HipGirth { get; set; }
        public float WaistLenghtSec { get; set; }
        public float UpperArmGirth { get; set; }
        public float WristGirth { get; set; }
        public float FrontLenght { get; set; }
        ...
        public float InsideLegLenght { get; set; }
        public float ArmLenght { get; set; }
        public float ShoulderLenght { get; set; }
        public float ArmholeLenght { get; set; }
        public float BackWidth { get; set; }
        public float WaistHeight { get; set; }
        public float BackLenght { get; set; }
